...
async def lifespan(app: FastAPI):
    """서버 시작 시 기업 목록을 미리 로드합니다."""
    logger.info("서버 시작: DART/KRX 기업 목록 로드를 시작합니다.")
...
def get_news_scaalping_serice () -> NewsScalpingService:
  return news_scalping_service
